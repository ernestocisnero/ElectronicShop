...
import { googleSignIn, logInUserEmailPassword, twitterSignIn } from "../../firebase";
...
export const Login = (): JSX.Element => {
    ...
    const handleTwitterLogIn = async (event: React.FormEvent): Promise<void> => {
        event.preventDefault();
                    ...
                    <div className="card shadow-2-strong" >
                        <div className="card-body p-5 text-center">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div>
                                    <button className="btn btn-primary mr-2" style={{ backgroundColor: '#dd4b39' }} onClick={handleGoogleLogIn}>
                                    ...
                                    <button className="btn btn-primary ml-2" style={{ backgroundColor: '#00ACEE' }} onClick={handleTwitterLogIn}>
